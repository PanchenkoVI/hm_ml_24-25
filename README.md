...
но с дополнительным столбцом прогнозирования стоимости автомобиля.
...
представлена также в последней в части (4) в разделе Feature Engineering. Представленная модель с дополнительными обработками
...
Заметил корень зла - OneHotEncoder. Даже при переносе pkl с юпитера модель распределяет значения некорректно.
